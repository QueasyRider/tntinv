...
export const DEMO_PRODUCTS: DemoSeed[] = [
  ...
  },
  {
    ...
    original: { title: "Electric West Jacket", description: "Structured 1980s denim jacket with authentic fading and bright brass hardware.", priceCents: 8500, sku: "TT-003", category: "Jackets", isTaxable: true, tags: ["denim", "80s", "usa"], quantity: 1, state: "active", images: [image("photo-1542272604-787c3835535d")], variants: [] },
  },
  {
    ...
    original: {
      title: "Cherry Bomb Boots", description: "Red leather western boots with a stacked heel and stitched flame detail.", priceCents: 12000, sku: "TT-004", category: "Boots", isTaxable: true, tags: ["western", "red", "leather"], quantity: 3, state: "active", images: [image("photo-1543163521-1bf539c55dd2")],
      variants: [
  ...
  },
  {
    ...
    original: { title: "Desert Dreamer Tee", description: "Single-stitch cream tee with a sun-faded desert graphic.", priceCents: 3200, sku: "TT-005", category: "Tops & Tees", isTaxable: true, tags: ["single stitch", "90s", "desert"], quantity: 3, state: "active", images: [image("photo-1576566588028-4147f3842f27")], variants: [
  ...
  },
  {
    ...
    original: { title: "Tooled Leather Bag", description: "Warm brown tooled leather shoulder bag with a floral western pattern.", priceCents: 6800, sku: "TT-006", category: "Bags", isTaxable: true, tags: ["leather", "western", "tooled"], quantity: 1, state: "active", images: [image("photo-1559563458-527698bf5295")], variants: [] },
  },
  {
    etsyListingId: "9321176607", status: "exported", squareItemId: "SQ-ITEM-INDIGO-BANDANA",
    original: { title: "Indigo Bandana", description: "Classic cotton paisley bandana in deep indigo blue.", priceCents: 1800, sku: "TT-007", category: "Accessories", isTaxable: true, tags: ["cotton", "bandana", "blue"], quantity: 5, state: "active", images: [image("photo-1603252110481-7ba873bf42ab")], variants: [] },
  },
  {
    etsyListingId: "9321176608", status: "ready",
    original: { title: "Road Trip Shades", description: "Gold-tone vintage aviators with smoke lenses and a slim wire frame.", priceCents: 4200, sku: "TT-008", category: "Accessories", isTaxable: true, tags: ["aviator", "sunglasses", "gold"], quantity: 2, state: "active", images: [image("photo-1511499767150-a48a237f0083")], variants: [] },
  },
];
